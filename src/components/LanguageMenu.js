...
const styles = StyleSheet.create({
    ...
    container: {
        position: "absolute", top: hp(14), width: wp(55),
        backgroundColor: COLORS.white, paddingVertical: hp(1),
        paddingHorizontal: wp(2), shadowColor: "#000", shadowOpacity: 0.3,
        shadowOffset: { width: -3, height: 0 },
        shadowRadius: 5, elevation: 5, borderTopLeftRadius: wp(4), borderBottomLeftRadius: wp(4),
        maxHeight: hp(30),
        marginRight: wp(2),
    }, closeButton: {
        position: "absolute", top: hp(1),
        right: wp(1), zIndex: 10, padding: wp(1),
    }, menuItem: {
        flexDirection: "row", justifyContent: "flex-start", alignItems: "center", paddingVertical: hp(1),
        paddingHorizontal: wp(2), borderBottomWidth: 0.5, borderBottomColor: "#ccc",
    },
    menuText: {
        fontSize: wp(5),
