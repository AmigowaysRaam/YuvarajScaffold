          ...
          >
            ...
            <View style={styles.statusEditRow}>
              <Pressable onPress={() => {
                ...
                <Icon name="edit" size={wp(6)} color="#fff" style={{ marginRight: wp(1) }} />
...
const styles = StyleSheet.create({
  ...
  modalContainer: {
    maxHeight: hp(95), backgroundColor: "#fff",
    minHeight: hp(95),
    // borderTopRightRadius: wp(6),
    padding: wp(4),
    shadowColor: "#000", shadowOpacity: 0.25, shadowRadius: 10, elevation: 15,
  },
  closeButton: {
    position: "absolute",
    top: wp(1),
    left: wp(4), width: wp(8),
    height: wp(10), borderRadius: wp(4.5),
    justifyContent: "center",
    alignItems: "center", zIndex: 10, borderWidth: wp(0.5), borderColor: "#FFF"
  },
  modalTitle: {
    fontSize: wp(4.9), fontFamily: "Poppins_700Bold", color: "#222",
    textTransform: "capitalize"
  }, descriptionContainer: {
    marginBottom: hp(1.5),
    maxHeight: SCREEN_HEIGHT * 0.2, borderRadius: wp(2.5), backgroundColor: "#f5f5f5",
    padding: wp(2.5)
  }, descriptionScroll: {
    paddingRight: wp(1)
  },
  ...
  statusText: {
    color: "#fff", fontSize: wp(3.2), fontFamily: "Poppins_500Medium"
  }, editButton: {
  ...
  editText: {
    color: "#fff", fontSize: wp(3.2), fontFamily: "Poppins_500Medium", marginLeft: wp(1)
  },
  mediaItem: {
  ...
  datesRow: {
    flexDirection: "row", justifyContent: "space-between", marginBottom: hp(1.5),
  }, dateItem: {
    flex: 1, borderWidth: wp(0.25), borderColor: COLORS.primary,
    borderRadius: wp(2), padding: wp(2.5), marginRight: wp(1.5)
  },
  dateRow: { flexDirection: "row", alignItems: "center" }, label: {
    fontSize: wp(2), fontFamily: "Poppins_400Regular",
    color: COLORS?.primary
  }, dateText: {
    fontSize: wp(2.8), fontFamily: "Poppins_500Medium",
    marginTop: hp(0.2), color: "#333"
  }, audioContainer: {
    marginTop: hp(1.5), alignItems: "center", padding: wp(1),
    borderRadius: wp(4), backgroundColor: "#eef6ff", justifyContent: "center",
    width: "100%"
  }, audioName: {
    fontSize: wp(2.8), fontFamily: "Poppins_500Medium", marginBottom: hp(0.8),
    flexDirection: "row"
  }, audioTitleRow: {
    flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: hp(1.2), width: "100%",
    padding: wp(1.5)
  }, audioControls: { flexDirection: "row", alignItems: "center", marginBottom: hp(0.8) },
  controlButton: {
    width: wp(11), height: wp(11), borderRadius: wp(5.5), backgroundColor: "#d6e4ff",
    justifyContent: "center", alignItems: "center", marginHorizontal: wp(1.5)
  }, playButton: { backgroundColor: COLORS.primary },
  progressBarBackground: {
    flexDirection: "row", width: wp(75), height: hp(1.2),
    borderRadius: hp(0.6), backgroundColor: "#ccc", overflow: "hidden",
    marginBottom: hp(0.5), marginVertical: hp(2)
  }, progressBarFill: { backgroundColor: COLORS.primary },
  progressBarRemaining: { backgroundColor: "#ddd" }, timeRow: {
    flexDirection: "row", justifyContent: "space-between", width: wp(75)
  },
  timeText: {
    fontSize: wp(2.5), color: "#333", fontFamily: "Poppins_400Regular"
  },
});